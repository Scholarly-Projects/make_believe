...
{% trigger type: image id: make_believe_088 action: end zoom: 12 coordinates: %}
...
{% trigger type: image id: make_believe_091 action: start zoom: coordinates: %}
...
{% trigger type: image id: make_believe_091 action: end zoom: coordinates: %}
